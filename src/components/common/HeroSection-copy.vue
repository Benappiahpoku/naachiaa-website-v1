  ...
  <section class="relative bg-gradient-to-br from-gray-900 via-blue-900 to-gray-800">
    <div class="max-w-7xl mx-auto px-4 py-10">
      ...
      <div class="flex flex-col md:flex-row items-center md:items-stretch gap-8">
        ...
        <section
          class="relative w-full md:w-1/2 order-1 md:order-1 rounded-xl flex items-center"
        ...
        <div class="w-full md:w-1/2 order-2 md:order-2 flex justify-center items-center">
          <img
            src="/heroImage.jpg"
            alt="Naachiaa Estates - concrete and construction"
            loading="lazy"
            decoding="async"
    ...
    <div
      v-if="!isOnline"
      class="fixed top-4 left-4 right-4 offline-alert rounded-xl shadow-xl z-50"
      role="alert"
      aria-live="polite"
    >
