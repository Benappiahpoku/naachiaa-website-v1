  ...
  <nav class="bg-gray-900 shadow-lg border-b-2 border-blue-600">
          ...
          <div class="hidden sm:ml-8 sm:flex sm:space-x-2">
            ...
            >
              ...
              <div 
                ...
                class="absolute bottom-0 left-1/2 transform -translate-x-1/2 w-8 h-1 bg-blue-400 rounded-t-full"
              ></div>
            </router-link>
          </div>
        </div>
    ...
    >
      <div 
        ...
        class="sm:hidden bg-gray-800 shadow-xl border-t border-gray-700" 
        id="mobile-menu"
      >
        <div class="px-4 pt-4 pb-6 space-y-2">
          ...
          >
            ...
            <div 
              v-if="$route.path === item.path"
              class="ml-auto w-2 h-2 bg-blue-300 rounded-full"
            ></div>
          </router-link>
